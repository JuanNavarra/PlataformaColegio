...
namespace Colegio.Services.Interfaces
{
    ...
    {
        public Task<ApiCallResult> GuardarAutorizaciones(List<Col_RolModulos> modulo, List<Col_SubModuloModulo> subModulo, string rol, string descripcion, bool restringir);
